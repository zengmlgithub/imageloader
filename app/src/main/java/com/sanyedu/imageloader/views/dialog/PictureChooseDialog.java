package com.sanyedu.imageloader.views.dialog;
...
public class PictureChooseDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.textColorBlue);
                mOtherItemColor = mActivity.getResources().getColor(R.color.textColorBlue);
            }
            if (1 == mStrings.size()) {
